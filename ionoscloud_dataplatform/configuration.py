...
conf = ionoscloud_dataplatform.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.ionos.com/dataplatform" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ionoscloud_dataplatform")
