...
class PatchClusterProperties(object):
    ...
    def __init__(self, name=None, data_platform_version=None, maintenance_window=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this PatchClusterProperties.  # noqa: E501
        ...
        :return: The name of this PatchClusterProperties.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PatchClusterProperties.

        The name of your cluster. Must be 63 characters or less and must begin and end with an alphanumeric character ([a-z0-9A-Z]) with dashes (-), underscores (_), dots (.), and alphanumerics between.   # noqa: E501

        :param name: The name of this PatchClusterProperties.  # noqa: E501
        :type name: str
        """
    ...
    def data_platform_version(self):
        """Gets the data_platform_version of this PatchClusterProperties.  # noqa: E501

        The version of the data platform.   # noqa: E501

        :return: The data_platform_version of this PatchClusterProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def data_platform_version(self, data_platform_version):
        """Sets the data_platform_version of this PatchClusterProperties.

        The version of the data platform.   # noqa: E501

        :param data_platform_version: The data_platform_version of this PatchClusterProperties.  # noqa: E501
