...
class NodePoolListResponseData(object):
    ...
    openapi_types = {
        ...
        'items': 'list[NodePoolResponseData]',
    }
    ...
    def __init__(self, id=None, type=None, href=None, items=None, local_vars_configuration=None):  # noqa: E501
        """NodePoolListResponseData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this NodePoolListResponseData.  # noqa: E501

        The ID of a list of resources.   # noqa: E501

        :return: The id of this NodePoolListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this NodePoolListResponseData.

        The ID of a list of resources.   # noqa: E501

        :param id: The id of this NodePoolListResponseData.  # noqa: E501
        :type id: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this NodePoolListResponseData.  # noqa: E501


        :return: The type of this NodePoolListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this NodePoolListResponseData.


        :param type: The type of this NodePoolListResponseData.  # noqa: E501
        :type type: str
        """
    ...
    @property
    def href(self):
        """Gets the href of this NodePoolListResponseData.  # noqa: E501


        :return: The href of this NodePoolListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._href
    ...
    @href.setter
    def href(self, href):
        """Sets the href of this NodePoolListResponseData.


        :param href: The href of this NodePoolListResponseData.  # noqa: E501
        :type href: str
        """
    ...
    @property
    def items(self):
        """Gets the items of this NodePoolListResponseData.  # noqa: E501


        :return: The items of this NodePoolListResponseData.  # noqa: E501
        :rtype: list[NodePoolResponseData]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this NodePoolListResponseData.


        :param items: The items of this NodePoolListResponseData.  # noqa: E501
        :type items: list[NodePoolResponseData]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NodePoolListResponseData):
            return False
