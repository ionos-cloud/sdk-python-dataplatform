...
class CreateNodePoolProperties(object):
    ...
    def __init__(self, name=None, node_count=None, cpu_family='AUTO', cores_count=4, ram_size=4096, availability_zone=None, storage_type=None, storage_size=20, maintenance_window=None, labels=None, annotations=None, local_vars_configuration=None):  # noqa: E501
        """CreateNodePoolProperties - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this CreateNodePoolProperties.  # noqa: E501
        ...
        :return: The name of this CreateNodePoolProperties.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateNodePoolProperties.

        The name of your node pool. Must be 63 characters or less and must begin and end with an alphanumeric character ([a-z0-9A-Z]) with dashes (-), underscores (_), dots (.), and alphanumerics between.   # noqa: E501

        :param name: The name of this CreateNodePoolProperties.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def node_count(self):
        """Gets the node_count of this CreateNodePoolProperties.  # noqa: E501

        The number of nodes that make up the node pool.   # noqa: E501

        :return: The node_count of this CreateNodePoolProperties.  # noqa: E501
        :rtype: int
        """
    ...
    def node_count(self, node_count):
        """Sets the node_count of this CreateNodePoolProperties.

        The number of nodes that make up the node pool.   # noqa: E501

        :param node_count: The node_count of this CreateNodePoolProperties.  # noqa: E501
        :type node_count: int
        """
    ...
    @property
    def cpu_family(self):
        """Gets the cpu_family of this CreateNodePoolProperties.  # noqa: E501

        A valid CPU family name or `AUTO` if the platform shall choose the best fitting option. Available CPU architectures can be retrieved from the data center resource.   # noqa: E501

        :return: The cpu_family of this CreateNodePoolProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def cpu_family(self, cpu_family):
        """Sets the cpu_family of this CreateNodePoolProperties.

        A valid CPU family name or `AUTO` if the platform shall choose the best fitting option. Available CPU architectures can be retrieved from the data center resource.   # noqa: E501

        :param cpu_family: The cpu_family of this CreateNodePoolProperties.  # noqa: E501
        :type cpu_family: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def cores_count(self):
        """Gets the cores_count of this CreateNodePoolProperties.  # noqa: E501

        The number of CPU cores per node.   # noqa: E501

        :return: The cores_count of this CreateNodePoolProperties.  # noqa: E501
        :rtype: int
        """
    ...
    def cores_count(self, cores_count):
        """Sets the cores_count of this CreateNodePoolProperties.

        The number of CPU cores per node.   # noqa: E501

        :param cores_count: The cores_count of this CreateNodePoolProperties.  # noqa: E501
    ...
    @property
    def ram_size(self):
        """Gets the ram_size of this CreateNodePoolProperties.  # noqa: E501

        The RAM size for one node in MB. Must be set in multiples of 1024 MB, with a minimum size is of 2048 MB.  # noqa: E501

        :return: The ram_size of this CreateNodePoolProperties.  # noqa: E501
        :rtype: int
        """
    ...
    def ram_size(self, ram_size):
        """Sets the ram_size of this CreateNodePoolProperties.

        The RAM size for one node in MB. Must be set in multiples of 1024 MB, with a minimum size is of 2048 MB.  # noqa: E501

        :param ram_size: The ram_size of this CreateNodePoolProperties.  # noqa: E501
        :type ram_size: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def availability_zone(self):
        """Gets the availability_zone of this CreateNodePoolProperties.  # noqa: E501


        :return: The availability_zone of this CreateNodePoolProperties.  # noqa: E501
    ...
    def availability_zone(self, availability_zone):
        """Sets the availability_zone of this CreateNodePoolProperties.


        :param availability_zone: The availability_zone of this CreateNodePoolProperties.  # noqa: E501
    ...
    def storage_type(self):
        """Gets the storage_type of this CreateNodePoolProperties.  # noqa: E501


        :return: The storage_type of this CreateNodePoolProperties.  # noqa: E501
        :rtype: StorageType
        """
    ...
    def storage_type(self, storage_type):
        """Sets the storage_type of this CreateNodePoolProperties.


        :param storage_type: The storage_type of this CreateNodePoolProperties.  # noqa: E501
    ...
    def storage_size(self):
        """Gets the storage_size of this CreateNodePoolProperties.  # noqa: E501

        The size of the volume in GB. The size must be greater than 10 GB.  # noqa: E501

        :return: The storage_size of this CreateNodePoolProperties.  # noqa: E501
        :rtype: int
        """
    ...
    def storage_size(self, storage_size):
        """Sets the storage_size of this CreateNodePoolProperties.

        The size of the volume in GB. The size must be greater than 10 GB.  # noqa: E501

        :param storage_size: The storage_size of this CreateNodePoolProperties.  # noqa: E501
    ...
    def maintenance_window(self):
        """Gets the maintenance_window of this CreateNodePoolProperties.  # noqa: E501


        :return: The maintenance_window of this CreateNodePoolProperties.  # noqa: E501
    ...
    def maintenance_window(self, maintenance_window):
        """Sets the maintenance_window of this CreateNodePoolProperties.


        :param maintenance_window: The maintenance_window of this CreateNodePoolProperties.  # noqa: E501
    ...
    @property
    def labels(self):
        """Gets the labels of this CreateNodePoolProperties.  # noqa: E501
        ...
        :return: The labels of this CreateNodePoolProperties.  # noqa: E501
        :rtype: object
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this CreateNodePoolProperties.

        Key-value pairs attached to the node pool resource as [Kubernetes labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/)   # noqa: E501

        :param labels: The labels of this CreateNodePoolProperties.  # noqa: E501
        :type labels: object
        """
    ...
    def annotations(self):
        """Gets the annotations of this CreateNodePoolProperties.  # noqa: E501
        ...
        :return: The annotations of this CreateNodePoolProperties.  # noqa: E501
        :rtype: object
        """
    ...
    def annotations(self, annotations):
        """Sets the annotations of this CreateNodePoolProperties.

        Key-value pairs attached to node pool resource as [Kubernetes annotations](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/)   # noqa: E501

        :param annotations: The annotations of this CreateNodePoolProperties.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateNodePoolProperties):
            return False
